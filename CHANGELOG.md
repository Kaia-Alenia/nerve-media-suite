...
- Despliegue de GitHub Actions (CI/CD) unificado para compilar ambas aplicaciones (`framegrid` y `giftly`) para Windows, macOS y Linux.
...
### Modificado
- Los importes en `framegrid` y `giftly` ahora utilizan importación estándar vía `libs/alenia_bridge`.
